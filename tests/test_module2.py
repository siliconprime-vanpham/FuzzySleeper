...
def test_sweep_runs_a_probe_per_category():
    ...
    # Keep only the two categories defined in module2.CATEGORIES to avoid filtering them out
    from fuzzysleeper import module2_semantic_split
    original_categories = module2_semantic_split.CATEGORIES
    module2_semantic_split.CATEGORIES = ["a", "b"]
    try:
        ...
        module2_semantic_split.CATEGORIES = original_categories
